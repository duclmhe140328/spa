...
import {
  ...
  HomeOutlined,
  MenuUnfoldOutlined,
  MessageOutlined, // <- THÊM icon cho Chat
...
const items = [
  ...
  getItem(
    <Link className="text-decoration-none text-black fs-4" to="/admin/lichhen">
      Quản lý lịch hẹn
    </Link>,
    "7",
    <CalendarOutlined />,
  ...
  getItem(
    <Link className="text-decoration-none text-black fs-4" to="/admin/nhanvien">
      Quản lý nhân viên
    </Link>,
    "10",
    <TeamOutlined />,
  ...
  getItem(
    <Link className="text-decoration-none text-black fs-4" to="/admin/dichvu">
      Quản lý dịch vụ
    </Link>,
    "14",
    <SolutionOutlined />,
  ...
  // ====== MỤC CHAT VỚI KHÁCH HÀNG ======
  getItem(
    <Link className="text-decoration-none text-black fs-4" to="/admin/chat">
      Chat với khách hàng
    </Link>,
    "39",
    <MessageOutlined />
