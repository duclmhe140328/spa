...
Route::group([
    ...
    // Chat admin
    Route::get('/chat/messages', [ChatController::class, 'indexAdmin']);
    Route::post('/chat/messages', [ChatController::class, 'storeAdmin']);
    Route::get('/chat/conversations', [ChatController::class, 'conversationsAdmin']);
});
...
Route::group([
    ...
    // Chat client
    Route::get('/chat/messages', [ChatController::class, 'indexClient'])
        ->middleware('auth:customer_api');
    Route::post('/chat/messages', [ChatController::class, 'storeClient'])
        ->middleware(['auth:customer_api', 'checkStatusCustomer']);
});
//END Client
